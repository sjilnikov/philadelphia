...
type
  ...
  TMD5Digest = record
    class operator equal(fDigest1: TMD5Digest; fDigest2: TMD5Digest): bool;
...
class operator TMD5Digest.equal(fDigest1: TMD5Digest; fDigest2: TMD5Digest): bool;
begin
  result:= (fDigest1.A = fDigest2.A) and (fDigest1.B = fDigest2.B) and (fDigest1.C = fDigest2.C) and (fDigest1.D = fDigest2.D);
end;
